...
## System Description
Kodezi Chronos-1 is an advanced code repair model that leverages a novel hybrid agent architecture. For full technical details, see our [technical report](https://arxiv.org/abs/2507.12482).
